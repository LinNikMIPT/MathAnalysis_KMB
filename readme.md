...
- Числовые функции и их свойства. Непрерывность и предел функции в точке.
- Понятие производной и дифференциала, их свойства. Таблица производных, вычисление проивзодной.
- Первообразная и неопределенный интеграл. Методы интегрирования.
- Функции многих переменных: метрическое пространство $\mathbb{R}^n$, предел функции многих переменных. Частные производные и дифференцируемость.
- Интегрирование функции многих переменных.
- Числовые ряды, их свойства. Исследование сходимости интегралов и рядов.
- Обыкновенные дифференциальные уравнения: примеры задач, приводящие к ДУ.
- Методы решений основных типов дифференциальных уравнений.
...
| Комплексные числа | С1, $\S 5$: 1-7, 13, 14, 25-27, 29, 33 | 
...
1. Дата: 11.10.2023
2. Темы:
    - Множества и операции над ними. Декартово произвдение.
    - Понятие отображения. Виды отображений.
    - Понятия об алгебраических структурах: группа, кольцо, поле.
    - Представление комплесных чисел в различных формах и операции над ними. Формула Муавра.
